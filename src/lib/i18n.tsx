...
export const DICT: Record<Lang, Record<string, string>> = {
  ar: {
    ...
    "landing.features.f1.t": "دقة علمية حقيقية",
    "landing.features.f1.d": "محرك برمجة خطية (LP) يحسب أرخص عليقة متوازنة تحقق احتياجات الحيوان من البروتين والطاقة والألياف — بدقة علمية معتمدة على معايير NRC.",
    ...
    "landing.features.f5.t": "توفير مالي يومي",
    "landing.features.f5.d": "الموازن الاقتصادي يرتّب المكوّنات البديلة الأرخص التي تحقق نفس القيمة الغذائية، ويوريك التوفير بالجنيه يومياً وشهرياً.",
    "landing.features.f6.t": "أسعار سوقك أنت",
    "landing.features.f6.d": "أسعار قابلة للتعديل لكل مكوّن، تُحفظ تلقائياً على جهازك وتتحدث بأسعار سوقك الأسبوعي. التركيبة تُعاد لحظياً مع كل تغيير سعر.",
    "landing.features.f7.t": "مقارنة العليقات",
    "landing.features.f7.d": "قارن عليقتين جنباً إلى جنب: البروتين، الطاقة، التكلفة، والمكوّنات",
    "landing.features.f8.t": "شارك العليقة فوراً",
    "landing.features.f8.d": "احفظ علائقك في سجل منظم، شاركها عبر واتساب مباشرة، أو اطبعها كتقرير PDF احترافي للمزرعة.",
    ...
    "about.intro":
      "أداة تقنية مجانية تساعد مربي الأبقار والجاموس والأغنام والدواجن في مصر على تركيب العلائق الغذائية بدقة علمية وبأقل تكلفة، بناءً على ٢٢ مكوّن من مكوّنات السوق المصري. التطبيق لا يبيع ولا يورد مستلزمات — هو أداة حسابية بحتة تعمل بالكامل على متصفحك بدون تسجيل.",
    "about.f1.t": "محرك برمجة خطية حقيقي",
    "about.f1.d": "يحلّ أرخص عليقة متوازنة عبر خوارزمية Simplex على جهازك نفسه — لا خوادم ولا انتظار. يدعم ٩ أنواع حيوانات بأهداف NRC معدّلة للسوق المصري.",
    "about.f2.t": "محرر يدوي بالبطاقات",
    "about.f2.d": "عدّل النسب يدوياً بكروت منظمة حسب الفئة (طاقة/بروتين/ألياف...) مع شريط تمرير وزر قفل لكل مادة. التوزيع الذكي يضمن بقاء المجموع ١٠٠٪.",
    "about.f3.t": "إعادة التوازن الذكي",
    "about.f3.d": "زر واحد يعيد تشغيل محلل البرمجة الخطية مع احترام الخامات المقفلة والحدود، ويوزّع باقي المواد للحصول على أفضل حل.",
    "about.f4.t": "مقارنة وطباعة احترافية",
    "about.f4.d": "قارن عليقتين جنباً إلى جنب (بروتين/طاقة/تكلفة/مكوّنات)، واطبع تقرير A4 منسّق بالعربي والإنجليزي للمشاركة أو الأرشفة.",
    "about.how_title": "كيف يعمل التطبيق؟",
    "about.step1": "اختر نوع الحيوان وحالته الإنتاجية (٩ أنواع: بقرة، جاموس، أغنام، دواجن...).",
    "about.step2": "أدخل وزن الحيوان والإنتاج وحجم القطيع.",
    "about.step3": "اختر الخامات تلقائياً أو يدوياً من ٢٢ مكوّن متاح.",
    "about.step4": "اختر عليقة متوازنة أو اقتصادية.",
    "about.step5": "تأكد من أسعار اليوم وعدّلها بأسعار سوقك.",
    "about.step6": "شاهد التركيبة، عدّلها يدوياً إن أردت، ثم احفظها أو شاركها عبر واتساب أو اطبعها.",
    ...
    "about.components_title": "المكوّنات المدعومة (٢٢ مكوّن)",
    ...
    "about.targets_summary": "البقرة الحلوب (بروتين ١٥٪، طاقة ٦٥٪) — جاموس حلوب (بروتين ١٤.٥٪، طاقة ٦٥٪) — جاموس تسمين (بروتين ١٢.٥٪، طاقة ٦٧٪) — عجول تسمين (بروتين ١٥٪، طاقة ٦٨٪) — الأغنام (بروتين ١٣.٥٪، طاقة ٦٦٪) — الدجاج البياض (بروتين ١٦.٥٪، طاقة ٦٧٪) — أمهات بياض (بروتين ١٦٪، طاقة ٦٨٪) — دجاج التسمين (بروتين ٢٠٪، طاقة ٧١٪) — كتاكيت البادي (بروتين ٢٣٪، طاقة ٧٢٪). للدواجن يمكنك تحديد عدد الطيور في القطيع لحساب التكلفة الإجمالية.",
  ...
  en: {
    ...
    "landing.features.f1.t": "Real scientific accuracy",
    "landing.features.f1.d": "A Linear Programming (LP) engine finds the cheapest balanced ration that meets the animal's protein, energy, and fiber needs — based on NRC standards.",
    ...
    "landing.features.f5.t": "Daily money savings",
    "landing.features.f5.d": "The cost optimizer ranks cheaper alternative ingredients with the same nutritional value, showing savings in EGP daily and monthly.",
    "landing.features.f6.t": "Your market prices",
    "landing.features.f6.d": "Editable prices for every ingredient, auto-saved on your device and updated with your weekly market. The ration recomputes instantly on every price change.",
    ...
    "landing.features.f8.t": "Share instantly",
    "landing.features.f8.d": "Save your rations in an organized history, share via WhatsApp directly, or print as a professional PDF report.",
    ...
    "about.intro":
      "A free technical tool that helps Egyptian cattle, buffalo, sheep, and poultry farmers formulate rations with scientific accuracy at the lowest cost, based on 22 Egyptian market ingredients. The app sells nothing and supplies nothing — it's a pure calculation tool that runs entirely in your browser with no sign-up.",
    "about.f1.t": "Real LP Engine",
    "about.f1.d": "Solves the cheapest balanced ration via a Simplex algorithm on your own device — no servers, no waiting. Supports 9 animal types with NRC targets tuned for the Egyptian market.",
    "about.f2.t": "Card-Based Manual Editor",
    "about.f2.d": "Edit percentages manually with cards grouped by category (energy/protein/fiber...) with a slider and lock button per ingredient. Smart distribution keeps the total at 100%.",
    "about.f3.t": "Smart Rebalance",
    "about.f3.d": "One button re-runs the LP solver while respecting locked ingredients and bounds, distributing the rest for the best solution.",
    "about.f4.t": "Comparison & Professional Printing",
    "about.f4.d": "Compare two rations side by side (protein/energy/cost/components), and print a formatted A4 report in Arabic and English for sharing or archiving.",
    "about.how_title": "How does the app work?",
    "about.step1": "Pick the animal type and production stage (9 types: cow, buffalo, sheep, poultry...).",
    "about.step2": "Enter the animal's weight, production, and flock size.",
    "about.step3": "Choose ingredients automatically or manually from 22 available.",
    "about.step4": "Choose balanced or economy ration.",
    "about.step5": "Check today's prices and adjust to your market.",
    "about.step6": "View the ration, edit manually if desired, then save, share via WhatsApp, or print.",
    ...
    "about.components_title": "Supported ingredients (22 ingredients)",
    ...
    "about.targets_summary": "Dairy cow (protein 15%, energy 65%) — Dairy buffalo (protein 14.5%, energy 65%) — Fattening buffalo (protein 12.5%, energy 67%) — Fattening calf (protein 15%, energy 68%) — Sheep (protein 13.5%, energy 66%) — Layer chicken (protein 16.5%, energy 67%) — Layer breeder (protein 16%, energy 68%) — Broiler (protein 20%, energy 71%) — Broiler starter (protein 23%, energy 72%). For poultry you can set the flock size to compute the total cost.",
